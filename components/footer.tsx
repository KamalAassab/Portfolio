...
const socialLinks = [
  {
    name: "GitHub",
    href: "https://www.github.com/KamalAassab",
    icon: Github,
  },
  {
    name: "LinkedIn",
...
export function Footer() {
  return (
    <footer className="w-full border-t border-border py-12" role="contentinfo">
      <div className="w-full px-4 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 max-w-full">
          <div className="text-center md:text-left">
            <p className="text-sm text-muted-foreground">© {new Date().getFullYear()} Kamal Aassab</p>
          </div>
